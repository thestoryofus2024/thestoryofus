...
# define b = Character("Boy", color="#66CCFF")
# define g = Character("Girl", color="#FF66CC")
...
#     play music "All I've Ever Known.mp3" loop

#     n "Once upon a time, there was a boy and a girl"

#     n "and Steve! (Steve was wholesome)"

#     show the-boy-main at left
#     with dissolve

#     show the-girl-main at right
#     with dissolve

#     # Dialogue
#     b "Hey, do you come here often?"
#     g "Sometimes. It's peaceful by the river, isn't it?"
#     b "Yeah, I could stay here forever."

#     # Change background to walking by the river
#     scene walking_river with dissolve

#     n "They walked by the river and talked about their dreams. They could feel no tiredness, no pain, not even time passing when they were together."

#     g "What are your dreams, boy?"
#     b "To be happy. To find something, someone to hold onto."

#     # Add emotional shifts
#     b "And you?"
#     g "I dream of finding hope. A hope that shines brightly, no matter what."

#     n "The boy could feel something changing in him. The girl was moving into his heart, one centimeter closer every day."

#     # Switch to lying under the cloudy sky scene
#     scene cloudy_sky with fade

#     n "Until one day, the boy looked into the girl's eyes as they were lying down under the cloudy sky and saw something he had never seen before."

#     g "What is it?"
#     b "Your eyes... they’re shining."

#     n "A glimmer of hope, shining from her soul. It was magnificent, a magical light, yet so fragile."

#     # Emotional moment
#     b "I see a future. Under this light, I see colors I never imagined... A bright future."

#     # Pause for emotional impact
#     pause 2

#     n "The boy was scared. Now, he had something to lose."

#     b "I don't want to lose you. I want to watch the glimmer of hope dancing in your eyes forever."

#     # Boy crying
#     show b cry with dissolve
#     b "But... I’m scared. What if I lose you?"
    
#     # Girl looks sad
#     show g sad with dissolve
#     g "I can’t stay forever. I have to go..."

#     n "And just like that, the girl had to leave. The boy's heart wasn’t beating the same way as before."

#     b "My heart... it aches. It's not the same anymore."

#     n "But he knew, no matter where the girl went, he would always carry that glimmer of hope with him."
